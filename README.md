...
This will install python and the doit package (from [[requirements.txt]] , decrypt the 'private' data and process it with the example scripts (that run upper/lowercase on it). 
